...
Shared tracked material is `AGENTS.md`, `README.md`, `CONTRIBUTING.md`, `.tasks.toml`, `.github/workflows/`, `.github/hooks/`, `bin/`, `.agents/skills/`, and public `skills/`.
...
.github/hooks/       GitHub Copilot CLI lifecycle hooks, committed
...
The verified harnesses are `claude`, `codex`, `copilot`, `opencode`, `pi`, `pi-signed`, `grok`, and `kimi`, plus `muse` for crewmates and scouts only; never dispatch on an unverified adapter.
