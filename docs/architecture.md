...
That keeps spawn launch compatible across claude, codex, copilot, opencode, pi, pi-signed, grok, kimi, and muse while preserving the requested profile for later audit.
