...
- GitHub Copilot CLI registers `agentStop` in `.github/hooks/firstmate.json` for local sessions; the adapter stays inert for Copilot cloud-agent jobs, including GitHub Actions.
