...
copilot shared efforts are accepted^{"rules":[{"when":"copilot low","use":{"harness":"copilot","effort":"low"}},{"when":"copilot medium","use":{"harness":"copilot","effort":"medium"}},{"when":"copilot high","use":{"harness":"copilot","effort":"high"}},{"when":"copilot xhigh","use":{"harness":"copilot","effort":"xhigh"}},{"when":"copilot max","use":{"harness":"copilot","effort":"max"}}]}^empty^
unsupported copilot effort is flagged^{"rules":[{"when":"copilot ultra","use":{"harness":"copilot","model":"gpt-5.6-sol","effort":"ultra"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: copilot:ultra
